            ...
            <md-list-item>
                <md-field>
                    ...
                    <md-select v-model="locale">
                        <md-option v-for="item in locales" :key="item.value" :value="item.value">
                            {{ item.label }}
                        </md-option>
                    </md-select>
                </md-field>
                    ...
                    <md-select v-model="entities" multiple>
                        <template v-for="(lists, language) in entityLists">
                            <md-optgroup :key="language" :label="$t('language', language)">
                                <md-option v-for="(list, key) in lists" :key="language + '.' + key" :value="language + '.' + key">
                                    {{ list.name }}
                                </md-option>
                            </md-optgroup>
                        </template>
                ...
                <md-field>
                    ...
                    <md-select v-model="sounds">
                        <md-option :value="true">
                            {{ $t('settings.sounds-enabled') }}
                        </md-option>
                        <md-option :value="false">
                            {{ $t('settings.sounds-disabled') }}
                        </md-option>
                    </md-select>
                </md-field>
            </md-list-item>
